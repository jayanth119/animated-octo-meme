...
const Login = () => {
  ...
  return (
    <div ref={containerRef} className="login-page-container" style={{
      display: 'flex',
      minHeight: '100vh',
        ...
        <div className="visual-panel-content" style={{ position: 'relative', zIndex: 2, maxWidth: '440px', color: '#ffffff', display: 'flex', flexDirection: 'column', gap: '32px' }}>
          <div>
            <div style={{
              ...
              <Zap style={{ color: '#ffffff', width: '26px', height: '26px' }} />
            </div>
            ...
            <p style={{ fontSize: '15px', color: 'rgba(255, 255, 255, 0.7)', lineHeight: '1.6', margin: 0 }}>
              Join thousands of teams who have optimized their operations with AutoBiz.
            </p>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <span style={{ fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', color: 'rgba(255,255,255,0.5)' }}>Quick Demo Logins</span>
              <div style={{ height: '1px', backgroundColor: 'rgba(255,255,255,0.15)', flex: 1 }} />
            </div>
      ...
      <div className="form-panel" style={{
        ...
        <div className="form-panel-content" style={{ maxWidth: '380px', width: '100%', margin: '0 auto' }}>
          ...
          <p className="form-element text-para" style={{ marginBottom: '36px', fontSize: '14px' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div className="form-group form-element">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', marginBottom: '4px' }}>
                ...
                <a href="#" style={{ fontSize: '11px', fontWeight: 700, color: '#000000', textDecoration: 'none', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                  Forgot password?
                </a>
              </div>
              <div className="form-input-wrapper">
          ...
          <p className="form-element" style={{ textAlign: 'center', fontSize: '13px', color: 'var(--text-muted)', marginTop: '32px' }}>
